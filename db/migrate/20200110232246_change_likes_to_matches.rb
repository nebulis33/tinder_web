class ChangeLikesToMatches < ActiveRecord::Migration[6.0]
  ...
  def down
    ...
    remove_column :likes, :account_1, :account_id
    remove_column :likes, :account_2, :liked_account_id
    rename_coloumn :likes, :account_1_approves
    rename_coloumn :likes, :account_2_approves
  end
end
